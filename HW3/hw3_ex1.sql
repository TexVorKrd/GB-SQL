USE GB;
DROP TABLE salespeaople;
CREATE TABLE salespeaople (
snum INT NOT NULL,
sname VARCHAR(50) NOT NULL,
city VARCHAR(50) NOT NULL,
comm DECIMAL(10,2) NOT NULL
);
INSERT INTO salespeaople (snum, sname, city, comm) VALUES
...
(3002,1900.10,'1990-3-10',2007,1004),
...
(3008,4723.00,'1990-5-10',2006,1001),
(3010,1309.95,'1990-6-10',2004,1002),
(3011,9891.88,'1990-7-10',2006,1001);
